...
const Navbar = () => {
    const navLink = <>
        ...
        <li className=' cursor-pointer font-semibold text-lg mr-7'>Testimonials</li>
  ...
  <div className="">
    ...
    <div className=" flex items-center">
        ...
        <p className="btn btn-ghost tracking-wider text-4xl font-montserrat">M<span className="ml-[-8px] font-thin text-[#545454]">umair</span></p>
    </div>
  </div>
 <div>
 <div className="navbar-center hidden lg:flex">
  ...
  <div className=" w-fit">
    <a className="bg-[#FD6F00] px-4 py-2 text-xl font-normal text-white cursor-pointer rounded-md">Download CV</a>
  </div>
 </div>
</div>
        </div>
